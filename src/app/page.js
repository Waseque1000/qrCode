...
import { FiCamera, FiLayout, FiZap, FiShield, FiArrowRight, FiRefreshCw, FiExternalLink } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col items-center selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-emerald-100/30 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <nav className="w-full max-w-7xl px-6 py-8 flex justify-between items-center z-50">
        ...
        >
          ...
          <a href="#how-it-works" className="text-slate-500 hover:text-indigo-600 transition-colors">Process</a>
          <Link href="/dashboard" className="px-6 py-2.5 bg-slate-900 text-white rounded-full hover:bg-indigo-600 transition-all shadow-md active:scale-95">
            Launch App
          </Link>
        </motion.div>
      </nav>
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            ...
            <p className="text-slate-500 text-xl mb-12 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
              The fastest way to bridge mobile scanning with your desktop workflow. 
              <span className="text-indigo-600 font-semibold"> P2P Encrypted. </span> Zero Latency.
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
              <Link href="/dashboard" className="group px-10 py-5 bg-indigo-600 text-white font-bold rounded-2xl flex items-center gap-3 hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 active:scale-95">
                GET STARTED <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/scanner" className="px-10 py-5 bg-white text-slate-900 border-2 border-slate-100 font-bold rounded-2xl hover:border-indigo-600 hover:text-indigo-600 transition-all shadow-sm active:scale-95">
                OPEN SCANNER
              </Link>
            </div>
          </motion.div>
      ...
      <section id="features" className="w-full max-w-7xl px-6 py-32">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">POWERED BY PERFORMANCE</h2>
          <p className="text-slate-500 font-medium">Built with the modern web stack for ultimate speed</p>
        </div>
      ...
      <section id="how-it-works" className="w-full max-w-7xl px-6 py-32 rounded-[4rem] bg-slate-50/50 border border-slate-100">
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-6">How it works</h2>
          <p className="text-indigo-600 font-bold tracking-widest uppercase text-xs">Three steps to instant synchronization</p>
        </div>
             ...
             <div className="relative w-full max-w-4xl glass p-12 rounded-[3rem] border border-white overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                   ...
                   <div className="flex-1 flex flex-col items-center gap-4">
                      <div className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.3em]">Data Pipeline</div>
      ...
      <section className="w-full max-w-7xl px-6 py-40">
         <div className="bg-indigo-600 rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-300">
            ...
            >
              <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter">READY TO SYNC?</h2>
              <p className="text-indigo-100 text-xl mb-12 max-w-2xl mx-auto font-medium">
                Join thousands of users bridging the gap between physical and digital data with QR Sync.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-center">
                <Link href="/dashboard" className="px-10 py-5 bg-white text-indigo-600 font-bold rounded-2xl hover:bg-slate-50 transition-all shadow-xl active:scale-95">
                  LAUNCH DASHBOARD
                </Link>
                <Link href="#" className="flex items-center gap-2 text-white font-bold group">
                   VIEW SOURCE ON GITHUB <FiExternalLink className="group-hover:translate-y-[-2px] transition-transform" />
                </Link>
              </div>
            </motion.div>
         </div>
      ...
      <footer className="w-full py-16 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-slate-50 gap-6">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em]">© 2026 QRSYNC ECOSYSTEM</div>
